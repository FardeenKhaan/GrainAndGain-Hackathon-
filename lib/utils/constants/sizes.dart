...
class FkSizes {
  ...
  // Image sizes
  static const double imageThumbSize = 110.0;
  ...
  static const double cheatCardHeight = 192.0;
  static const double cheatCardWidth = 140.0;

  static const double categorySize = 70.0;
